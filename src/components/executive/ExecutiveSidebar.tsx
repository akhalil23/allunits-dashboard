...
import {
  ...
  GitCompare, Brain, ChevronRight, Menu, X, Shield, LogOut, Camera, BookOpen, FileText, History,
} from 'lucide-react';
...
export type ExecutiveTab = 'snapshot' | 'risk-priority' | 'budget' | 'comparison' | 'ai-insights' | 'reports' | 'my-sessions' | 'guide';
...
const tabs: { id: ExecutiveTab; label: string; icon: React.ElementType }[] = [
  ...
  { id: 'my-sessions', label: 'My Sessions', icon: History },
              ...
              >
                <div className="flex items-center justify-between px-4 pt-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h1 className="text-white font-display font-bold text-xs tracking-wider">Executive</h1>
                      <p className="text-white/50 text-[9px] tracking-widest uppercase">Command Center</p>
                    </div>
                  </div>
                ...
                <div className="px-4 pb-4">
                  ...
                  <div className="px-3 py-2 rounded-lg bg-white/5 border border-white/10 mt-2">
                    <p className="text-[10px] text-white/40 leading-tight">
                      University Executive Command Center<br />
  ...
  return (
    <aside className="sidebar-gradient w-64 min-w-[16rem] h-screen flex flex-col shrink-0 min-h-0">
      <div className="px-4 pt-5 pb-4">
        <div className="flex flex-col items-center gap-3 px-3 py-4">
          ...
          <div className="text-center">
            <h1 className="text-white font-display font-bold text-sm leading-tight tracking-wider">Executive</h1>
            <p className="text-white/50 text-[10px] tracking-widest uppercase">Command Center</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 pb-4">
        <button
          onClick={() => navigate('/logout')}
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-white/60 hover:text-white hover:bg-white/10 text-sm transition-colors mb-2"
        >
          <LogOut className="w-4 h-4" />
          <span>Sign out</span>
        </button>
