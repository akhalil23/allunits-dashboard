      ...
      <section>
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }} className="relative rounded-2xl border border-border/60 bg-card shadow-sm overflow-hidden p-5 sm:p-6">
          ...
          <div className="space-y-1">
            ...
            <FAQItem question="What is the ADM unit?" answer="ADM (Administration) is a fully integrated reporting unit, captured by the same automated monthly snapshot pipeline as all other units." />
            <FAQItem question="What is the GC unit?" answer="GC (General Counsel) is the 26th reporting unit, fully integrated into routing, authentication, data ingestion, filters, comparisons, and university-level aggregations. Its data is captured by the same automated monthly snapshot pipeline as all other units." />
