...
import { blockedItems, RISK_COLOR } from '@/lib/healthcare/helpers';
import type { HCBlockerType } from '@/lib/healthcare/types';
import { AlertOctagon, User, Calendar, DollarSign } from 'lucide-react';
...
export default function DecisionBlockersBoard() {
  ...
  const filtered = filter === 'All' ? items : items.filter(i => i.step.blocker?.type === filter);
