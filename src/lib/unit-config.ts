...
export const UNIT_CONFIGS: Record<string, UnitConfig> = {
  ...
  SArD: { id: 'SArD', name: 'SArD', fullName: 'School of Architecture & Design', spreadsheetId: '1RfVZl-XYzQdo6FQK70PJhyw-qnnORM6LaE8Sg_cpFbA' },
  ...
  DIRA: { id: 'DIRA', name: 'DIRA', fullName: 'Department of Institutional Research & Assessment', spreadsheetId: '1iAKPKguUvCYEN-Tojo91TXR-f-RXLtaeO3awt0nDCDk' },
  CIL: { id: 'CIL', name: 'CIL', fullName: 'Center for Innovative Learning', spreadsheetId: '1KNm1MpH-vxgpD-z-_eguZyqsZd6nvEOk_S6LZG0WsvQ' },
  ...
  SDEM: { id: 'SDEM', name: 'SDEM', fullName: 'Student Development & Enrollment Management', spreadsheetId: '19423B49RTOlsR1oD7A9YhVfz14w5rP-wA7-sy-x4V04' },
  IT: { id: 'IT', name: 'IT', fullName: 'Information Technology', spreadsheetId: '1MYMfXSMFYksiMS3GUXGSoI12-2qg5V-UwMXv7XFshqw' },
  Facilities: { id: 'Facilities', name: 'Facilities', fullName: 'Facilities Management', spreadsheetId: '1FOwt5PkOPQnUX_NdmPbzPRbaan9MEeRoXiWB1i-FR0g' },
  Finance: { id: 'Finance', name: 'Finance', fullName: 'Finance', spreadsheetId: '1SWb0okdTuFZub8XFS6tclitCv-FRaSXbcvx6kagvvu4' },
  UGRC: { id: 'UGRC', name: 'UGRC', fullName: 'University General Requirements Committee', spreadsheetId: '1fX5EtFll-K2kFTIym1bf-SS_pbrcOwTpvAsEFdZHDuE' },
  ...
  PwD: { id: 'PwD', name: 'PwD', fullName: 'People with Disabilities', spreadsheetId: '1TEr6TeZ_rfHewK7_Pozl3DgHyK6Y1LTfyIt-P139T58' },
};
